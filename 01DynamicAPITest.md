...
<body>
  ...
  <script>
    ...
    function fetchCrashDataFromLastYear(limit = 1000) {
        const baseURL = "https://data.cityofnewyork.us/resource/h9gi-nx95.json";

  // Get today's date and subtract 1 year
  ...
  // Build the dynamic query
    const query = `
        ...
        WHERE number_of_cyclist_injured > 0
...
// Fetch crash data from exactly one year ago to today
    fetchCrashDataFromLastYear();
